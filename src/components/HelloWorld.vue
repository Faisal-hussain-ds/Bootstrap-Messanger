<template>
  <div class="hello">
    <div class="layout overflow-hidden">
      ...
      <!-- Modal: Profile -->
      <MyProfile v-show="true"/>
      <!-- Modal: User profile -->
        <UserProfile v-show="true"/>
      <!-- Modal: Media Preview -->
      <PreviewMedia/>
...
export default ({
  name: 'HelloWorld',
  components:{SideBar,UserCoversations,Messages,ChatInfo,AddMember,UserProfile,MyProfile,PreviewMedia},
  props: {
    msg: String,
  },
  setup()
